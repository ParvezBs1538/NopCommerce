...
namespace Nop.Plugin.Misc.NopStation.Controllers
{
    ...
    public class SkillController : BasePluginController
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            return View("~/Plugins/Misc.NopStation/Views/Skill/List.cshtml", searchModel);
        }
        ...
        public async Task<IActionResult> Create()
        {
            ...
            return View("~/Plugins/Misc.NopStation/Views/Skill/Create.cshtml", model);
        }
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            return View("~/Plugins/Misc.NopStation/Views/Skill/Edit.cshtml", model);
        }
